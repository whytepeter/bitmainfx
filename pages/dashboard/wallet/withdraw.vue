                ...
                <v-card flat class="px-md-4">
                  ...
                  <v-card-text>
                    <v-form @submit.prevent>
                      <div class="text-caption info--text mb-2">
                        Withdraw commission of $300 is applied to every
                        withdrawal before payment is approved
                      </div>
        ...
        <v-expansion-panels accordion>
          <v-expansion-panel>
            <v-expansion-panel-header>
              ...
              >Withdraw Notification</span>
              <v-spacer />
              <v-icon
                v-if="notifications.withdraw.length"
                :color="status(notifications.withdraw[0].status).color"
              >
                mdi-alert-circle
              </v-icon>
            </v-expansion-panel-header>
            <v-expansion-panel-content v-if="notifications.withdraw.length">
              <v-card
                v-for="(notif, i) in notifWithdraw"
                :key="i"
                class="mb-1"
                outlined
              >
...
export default {
  ...
  computed: {
    ...mapGetters({
      notifications: 'wallet/getNofitications',
      alert: 'authentication/getAlert',
      info: 'wallet/getWithdrawStatus',
      user: 'authentication/getUser',
      wallet: 'wallet/getWallet',
      invest: 'wallet/getInvestmentStatus',
  ...
  methods: {
    ...mapActions({
      withdraw: 'wallet/withdrawFund',
      sentCommission: 'wallet/sentCommission'
    }),
