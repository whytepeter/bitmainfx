<template>
  <v-container fluid class="primary ">
    <v-row justify="center" class="py-10 primary white--text">
      ...
      <v-col cols="12" md="10">
        <div style="border:1px solid #29b6f6; border-radius:7px; overflow:hidden">
...
export default {
  ...
  data: () => ({
    windowWidth: 0,
    faq: [
      { name: 'What is CFD?', des: ' CFD - Contract for Difference. CFD is type of financial asset which helps trader to gain and earn in a continuous way. By predicting the move of a currency, trader can choose to open BUY or SELL contract for any asset' },
