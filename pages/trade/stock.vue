<template>
  <v-container fluid class="pa-0 overflow">
    <v-row justify="center" class="bg-stock align-center px-md-16 px-4 py-16 primary ma-0">
...
export default {
  ...
  data: () => ({
    policies: [
      ...
      {
        name: 'How Do I Trade Stocks?',
        delay: 500,
        description: `
        <p>A stock market is where stocks are traded: where sellers and buyers come to agree on a price. Historically, stock exchanges existed in a physical location, and all transactions took place on the Mining floor. One of the world’s most famous stock markets is the London Stock Exchange (LSE).</p>
        ...
        <p>The reason Miners  choose to invest in stock is because the perceived value of a company can vary greatly over time. Money can be made or lost; it depends on whether the trader’s perceptions of the stock value are in line with the market.</p>
        ...
        <p>In order to trade stocks, there must be a seller and a buyer; as not all Miners  have the same agenda, stocks are bought and sold at different times and for different reasons. Someone may sell their stock for profit, others sell it in order to cut losses, and some because they believe the value of the stock is about to change either way.</p>
        
        `
      },
      {
        name: 'Stock Mining Risk Assessment',
        delay: 500,
        description: `
        <p>All forms of financial investment carry a level of risk, and stock Mining is no different. Even Miners  with decades of experience cannot predict the correct price movements every single time.</p>
...
.bg-stock {
background: rgb(1,131,125);
background: linear-gradient(0deg, rgba(1,131,125,0.8) 5%, rgba(0,10,74,0.8) 95%),
