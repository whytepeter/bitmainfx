    ...
    return {
      ...
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        {
          ...
          name: 'description',
          content:
            'Bitmain FX is excited to announce the launch of our new cryptocurrency trading platform. '
        }
      ]
    }
  }
